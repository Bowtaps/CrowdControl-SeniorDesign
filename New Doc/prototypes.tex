...
\section{Sprint 2 Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint2/tabs.PNG}}
	\end{center}
...
\section{Sprint 3 Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint3/createAccount.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint3/email.PNG}}
	\end{center}
...
\section{Winter Sprint Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/createAccount.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/email.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/events.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/info.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/join.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/SprintW/messaging.PNG}}
	\end{center}
...
\section{Sprint 4 Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint4/join.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint4/messaging.PNG}}
	\end{center}
...
\section{Sprint 5 Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint5/groupInfo.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint5/leaving.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint5/login.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint5/map.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint5/messaging.PNG}}
	\end{center}
...
\section{Sprint 6 Prototype}
	...
	\begin{figure}[tbh]
	\begin{center}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/commands.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/confirm.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/groupActivity.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/invite.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/leaving.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/logIn.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/map.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/menu.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/messaging.PNG}}
	\fbox{\includegraphics[scale=.1]{Additional/Prototypes/Sprint6/settings.PNG}}
	\end{center}
