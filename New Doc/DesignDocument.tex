...
\author{\color{SDColor3}  Johnnathon Ackerman \and \color{SDColor3} Daniel Andrus\and  \color{SDColor3} Charles Bonn \and \color{SDColor3} Evan Hammer\and \color{SDColor3} Joseph Mowry }
