\hypertarget{class_WelcomeActivity.Android}{\section{WelcomeActivity Class Reference}
\label{class_WelcomeActivity.Android}\index{WelcomeActivity.Android@{WelcomeActivity.Android}}
}
...
%method
\hypertarget{class_WelcomeActivity.Android.onClick}{\index{WelcomeActivity.Android.onClick@{WelcomeActivity.Android.onClick}!WelcomeActivity.Android.onClick@{WelcomeActivity.Android.onClick}}
\index{WelcomeActivity.Android.onClick@{WelcomeActivity.Android.onClick}!WelcomeActivity.Android.onClick@{WelcomeActivity.Android.onClick}}
\subsubsection[{WelcomeActivity.Android.onClick}]{\setlength{\rightskip}{0pt plus 5cm}onClick (
\begin{DoxyParamCaption}
\item[{android.view.View}]{view}
\end{DoxyParamCaption}
)}}\label{WelcomeActivity.Android.onClick}
...
%method
\hypertarget{class_WelcomeActivity.Android.onCreateOptionsMenu}{\index{WelcomeActivity.Android.onCreateOptionsMenu@{WelcomeActivity.Android.onCreateOptionsMenu}!WelcomeActivity.Android.onCreateOptionsMenu@{WelcomeActivity.Android.onCreateOptionsMenu}}
\index{WelcomeActivity.Android.onCreateOptionsMenu@{WelcomeActivity.Android.onCreateOptionsMenu}!WelcomeActivity.Android.onCreateOptionsMenu@{WelcomeActivity.Android.onCreateOptionsMenu}}
\subsubsection[{WelcomeActivity.Android.onCreateOptionsMenu}]{\setlength{\rightskip}{0pt plus 5cm}onCreateOptionsMenu (
\begin{DoxyParamCaption}
\item[{android.view.Menu}]{menu}
\end{DoxyParamCaption}
)}}\label{WelcomeActivity.Android.onCreateOptionsMenu}
...
%method
\hypertarget{class_WelcomeActivity.Android.onCreateView}{\index{WelcomeActivity.Android.onCreateView@{WelcomeActivity.Android.onCreateView}!WelcomeActivity.Android.onCreateView@{WelcomeActivity.Android.onCreateView}}
\index{WelcomeActivity.Android.onCreateView@{WelcomeActivity.Android.onCreateView}!WelcomeActivity.Android.onCreateView@{WelcomeActivity.Android.onCreateView}}
\subsubsection[{WelcomeActivity.Android.onCreateView}]{\setlength{\rightskip}{0pt plus 5cm}onCreateView (
\begin{DoxyParamCaption}
\item[{android.view.View}]{parent}
\item[{java.lang.String}]{nam}
\item[{android.content.Context}]{context}
\item[{android.util.AttributeSet}]{attrs}
\end{DoxyParamCaption}
)}}\label{WelcomeActivity.Android.onCreateView}
...
%method
\hypertarget{class_WelcomeActivity.Android.onCreateView2}{\index{WelcomeActivity.Android.onCreateView2@{WelcomeActivity.Android.onCreateView2}!WelcomeActivity.Android.onCreateView2@{WelcomeActivity.Android.onCreateView2}}
\index{WelcomeActivity.Android.onCreateView2@{WelcomeActivity.Android.oonCreateView2}!WelcomeActivity.Android.onCreateView2@{WelcomeActivity.Android.onCreateView}}
\subsubsection[{WelcomeActivity.Android.onCreateView2}]{\setlength{\rightskip}{0pt plus 5cm}onCreateView (
\begin{DoxyParamCaption}
\item[{java.lang.String}]{nam}
\item[{android.content.Context}]{context}
\item[{android.util.AttributeSet}]{attrs}
\end{DoxyParamCaption}
)}}\label{WelcomeActivity.Android.onCreateView2}
