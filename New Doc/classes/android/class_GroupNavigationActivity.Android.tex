\hypertarget{class_GroupNavigationActivity.Android}{\section{GroupNavigationActivity Class Reference}
\label{class_GroupNavigationActivity.Android}\index{GroupNavigationActivity.Android@{GroupNavigationActivity.Android}}
}

\subsection*{Class GroupNavigationActivity}

\textit{class \textbf{GroupNavigationActivity}}\\
...
\item 
\hyperlink{class_GroupNavigationActivity.Android.onCreateView}{onCreateView} ()
\item 
\hyperlink{class_GroupNavigationActivity.Android.onCreateView2}{onCreateView} ()
...
%method
\hypertarget{class_GroupNavigationActivity.Android.onCreateView}{\index{GroupNavigationActivity.Android.onCreateView@{GroupNavigationActivity.Android.onCreateView}!GroupNavigationActivity.Android.onCreateView@{GroupNavigationActivity.Android.onCreateView}}
\index{GroupNavigationActivity.Android.onCreateView@{GroupNavigationActivity.Android.onCreateView}!GroupNavigationActivity.Android.onCreateView@{GroupNavigationActivity.Android.onCreateView}}
\subsubsection[{GroupNavigationActivity.Android.onCreateView}]{\setlength{\rightskip}{0pt plus 5cm}onCreateView (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{GroupNavigationActivity.Android.onCreateView}
...
%method
\hypertarget{class_GroupNavigationActivity.Android.onCreateView2}{\index{GroupNavigationActivity.Android.onCreateView2@{GroupNavigationActivity.Android.onCreateView2}!GroupNavigationActivity.Android.onCreateView2@{GroupNavigationActivity.Android.onCreateView2}}
\index{GroupNavigationActivity.Android.onCreateView2@{GroupNavigationActivity.Android.onCreateView2}!GroupNavigationActivity.Android.onCreateView2@{GroupNavigationActivity.Android.onCreateView2}}
\subsubsection[{GroupNavigationActivity.Android.onCreateView2}]{\setlength{\rightskip}{0pt plus 5cm}onCreateView (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{GroupNavigationActivity.Android.onCreateView2}
