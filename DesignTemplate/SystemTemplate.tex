...
\title{{\color{MSBlue1} \rule{\linewidth}{0.5mm}}\\[2mm] {\huge \bfseries \color{MSBlue1} Crowd Control }\\[-1mm] {\color{MSBlue1}\rule{\linewidth}{0.5mm}} \\  \vfill
{\LARGE \bfseries \color{MSBlue2} Senior Design Final Documentation }\\  \vfill 
{\color{MSBlue1} BowTaps} }
\author{\color{MSBlue1}  Johnnathon Ackerman \and \color{MSBlue1} Daniel Andrus\and  \color{MSBlue1} Charles Bonn \and \color{MSBlue1} Evan Hammer\and \color{MSBlue1} Joseph Mowry }
...
\input{requirements.tex}  %% Not research track
\input{design.tex}  %% All tracks
\input{testing.tex}  %% All tracks
\input{develop.tex} %% All tracks
...
\includepdf[pages={1-5}]{SoftwareContract/SoftwareContract-signed.pdf}
